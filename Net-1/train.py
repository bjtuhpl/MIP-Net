        ...
        if save_cp:
            if (epoch+1) % 20 == 0:
                ...
                torch.save(net.state_dict(),
                           dir_checkpoint + f'scale{img_scale}_72Img_vnet_bce/' +f'CP_epoch{epoch + 1}.pth')
...
def get_args():
    ...
    parser.add_argument('-s', '--scale', dest='scale', type=float, default=0.50,
