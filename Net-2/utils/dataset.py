...
class BasicDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        img0_file=glob('/home/zhangkai/zk/data/stage3/stage1/train1_index/'+'TMJ_'+idx+'.nii.gz')
        ...
        return {'image': torch.from_numpy(img), 'mask': torch.from_numpy(mask), 'img0': torch.from_numpy(img0)}
