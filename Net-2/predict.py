...
def predict_img(net,
    ...
    img = torch.from_numpy(BasicDataset.preprocess(full_img,mid_img, scale_factor))
...
def get_args():
    ...
    parser.add_argument('--output', '-o', default='/home/zhangkai/zk/results/TMJ_IPG/stage2/test_72Img_res_th0/', metavar='INPUT', nargs='+',
...
if __name__ == "__main__":
    ...
    for i, fn in enumerate(file_name(in_files)):
        ...
        img0 =sitk.ReadImage('/home/zhangkai/zk/results/TMJ_IPG/stage1/test_72Img/'+fn)
        ...
        if not args.no_save:
            ...
            # b = transform.resize(mask, (481, 481, 481))
