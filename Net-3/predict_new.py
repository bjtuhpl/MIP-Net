...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='checkpoints/40Img_tooth/CP_epoch120.pth',
                        metavar='FILE',help="Specify the file in which the model is stored")
    parser.add_argument('--input', '-i', default='data/imgs/test_160112/', metavar='INPUT', nargs='+',
                        help='filenames of input images')

    parser.add_argument('--output', '-o', default='data/pred/40Img_160112/', metavar='INPUT', nargs='+',
