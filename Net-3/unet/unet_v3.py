...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, trilinear=True):
        ...
        self.ds1 = SUp(128, 64, trilinear)
        self.up2 = Up(192, 64, 64, trilinear)
        self.ds2 = SUp(64, 32, trilinear)
...
if __name__ == '__main__':
    ...
    x = torch.rand((1,1,144,144,144),device=device) # [bsize,channels,Height,Width,Depth]
