...
class ConvDown(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.conv_down = nn.Sequential(
            nn.Conv3d(in_channels, out_channels-1, kernel_size=3, stride=2, padding=1),
            nn.ReLU(inplace=True)
        )
...
class OutConv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.convTrans = nn.ConvTranspose3d(in_channels, 1, kernel_size=3, stride=2,padding=1, output_padding=0,
                                            bias=True)
